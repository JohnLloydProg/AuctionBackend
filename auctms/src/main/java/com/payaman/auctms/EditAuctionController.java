...
public class EditAuctionController extends GenericAuctionController {
	...
	public void onSubmit(ActionEvent actionEvent) {
		try {
			Auction auction = toObject(true);
			Auction newAuction = AuctionService.getService().update(auction);
